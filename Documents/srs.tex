...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{wfd}
...
{ReqType_Functional}
{PUC_Analysis}
{IBM Watson API is ableto parse through twitter messages and apply an accurate score.}
...
{RegType_Functional}
{PUC_Analysis}
{Application able to run on a web browser, through entering keywords and selecting applicable filters.}
{All applicable tweets will be displayed when searched with associated scores}
{Searching applicable keyword will display the user with a page of pulled information with score ratings.}
{Medium}
{Created January 7, 2017}
\\\\
...
{ReqType_filter}
{PUC_Analysis}
{The user will able to personalize their request in terms of time, score and keyword.}
{The web app wants to deliver filters in a dynamic setting.}
{A user who is able to filter a given time period, score rating and keyword search should be able to view messages and scores filtered to the given time period}
{Medium}
{Created January 7, 2017}
\\\\

\subsubsection{Learning Requirements}
NA -- The software will not have any specific learning requirements.
...
There will be a tutorial page on the web app which shortly goes into detail on how to use the app and all its available settings.
...
NA -- Otherthen possible hardware and connectivity issues there should be no integrity problems.
